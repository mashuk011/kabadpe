...
const FrenchiesForgotPasswrd = () => {
    ...
    const [forgotpasswrdtext , setForgotPasswrdText] = useState('Reset Password  Request');
  ...
  return (
    <>
       ...
       <div className={thanksBx ? "frenchies-thanks-main frenthankmain" : "frenchies-thanks-main"}>
       ...
       <div className="thank-u-box thank-u-box2">
            ...
            <NavLink to='/frenchiesDashboard'  className='dashb-btn'> Dashboard </NavLink>
        ...
        <div className="admin-login-main">
          ...
          <div className={newPasswrd ? "forgot-newpasswrd-thanksmessage-mainbx newpasswrdactive" : "forgot-newpasswrd-thanksmessage-mainbx"}>
            ...
            <button  onClick={() => thanksFunc()} className="admin-form-btn mt-5"> Save Password </button>
             
                
            </div>

          <div className={forgtActive ? "forgot-password forgtpasswrdactive" : "forgot-password"}>
