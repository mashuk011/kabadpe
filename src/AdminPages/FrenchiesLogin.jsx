  ...
  return (
    <>
      <section className="admin-login-comp">
        <div className={frencParent ? "frenchies-login-parent-box frencparentactive" : "frenchies-login-parent-box"}>
        ...
        <div className="thank-u-box">
          ...
          <p>Thank You, Your application has been submitted, We will check and confirm via email or SMS.</p>

          <span  className='dashb-btn'> See You Soon </span>
          
        </div>
       
        <div className={ otp ? "admin-login-main otpactive" : "admin-login-main"}>
...
<form action="#">
            ...
            <button onClick={() => verifOtp()}  className="admin-form-btn mt-5">Verifi OTP</button>
          ...
          >
           ...
           <NavLink to="/forgotpassword"> <button className="admin-forgot-passwrd-btn">
              Forgot Password ?
            </button>
            </NavLink>

            <button  className="admin-form-btn admin-form-btn2 admin-form-btn3">Sign Me In</button>
          <button onClick={() => otpFunc()}  className="admin-form-btn admin-form-btn2 admin-form-btn4">Sign Me Up</button>
          </form>

         

          <p className="signuptext">
            Don't have an account ? <a href="#" onClick={() => frenchiesSubmitBtn()}>{signIn}</a>{" "}
          </p>
        </div>
        </div>
      </section>
