...
const BuyWaste = ({onclickBtn , onclickBuyWasteBtn , onclickCloseBuyWaste , onclickRedirectBuywaste}) => {
    ...
    const getUserInfoFromPhoneNumber = (phone) => {
      ...
      const userData = {
        name: 'Faiz Alam',
        address: '4929 c/10 kanti nagar old seelumpur delhi-110031 street no.-1 near medical'
    ...
    <>
      <section className="buy-waste-popup-comp">
        ...
        <div className="buy-waste-bx">
          ...
          <button className="guest-btn buy-waste-btn2 confirm-buy-wste-btn">
            Guest
          </button>
        ...
        <div className="user-info-flex-btn">
            ...
            <button onClick={ () => {onclickCloseBuyWaste() , onclickRedirectBuywaste()}} className="buy-waste-btn buy-waste-btn2 confirm-buy-wste-btn">
                Confirm
            </button>
