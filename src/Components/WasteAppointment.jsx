    ...
    <div
              ...
              >
                <div className="tab-main-bx tab-main-bx3">
                  ...
                  <p className="tex-line tex-line2">Today Appointments</p>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Cancelled</td>
                  ...
                  <p className="tex-line tex-line2">Upcoming Appointments</p>

                  <div className="prof-table-main-bx appoint-prof-table-main-bx wasteappoint-prof-table-main-bx">
                    <table>
                      <thead>
                        <tr>
                          <th>SN</th>
