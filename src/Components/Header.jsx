                  ...
                  >
                    <ul className="navigation clearfix ">
                      <li
                        ...
                        className={
                          navlink === "home"
                            ? "dropdown nav-link navlinkactive"
                            : "dropdown nav-link"
                        }
                      >
                        <a href="#">
                      ...
                      <li
                        ...
                        className={
                          navlink === "service"
                            ? "dropdown nav-link servicemenu navlinkactive"
                            : "dropdown nav-link servicemenu"
                        }
                      >
                        <a href="#">
                          <span>Services</span>
                      ...
                      <li
                        ...
                        className={
                          navlink === "about"
                            ? "aboutdrpdwn nav-link navlinkactive"
                            : "aboutdrpdwn nav-link"
                        }
                      >
                        <a href="#">
                          <span>About Us</span>
                      ...
                      <li
                        onClick={() => {
                          linkActive("login"), setUserForm(true);
                        }}
                        className={
                          navlink === "login"
                            ? " nav-link  navlinkactive"
