...
const Supportticket = () => {
  ...
  return (
    ...
    <div className="right-user-prof-search-flex-bx">
        ...
        <button onClick={() => setTicketForm(true)} className="u-prf-btn-bx">
            Create Ticket
        </button>
    ...
    <section className="support-ticket-comp">
                    ...
                    <tr>
                            <td>
                                <div className="u-p-tb-data sup-tb-data">
                                    <div className="t-icn t-numbr s-t-numb">
                                   1
                                    </div>
                            ...
                            <td>
                                <div className="u-p-tb-numb-bx sale-hist-data sup-tick-data">
                                    <NavLink to="/">
                                        <p>Lorem ipsum dolor sit amet consectetur  excepturi minus cumque soluta pariatur.</p>
                                    </NavLink>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <div className="supp-data">
                                <div className="u-p-tb-numb-bx sale-hist-data sup-tick-btn-flex">
                                    ...
                                    <button className='supp-btn-yelo'>
                                        Working
                                    </button>
                        ...
                        <tr>
                            ...
                            <div className="supp-data">
                                <div className="u-p-tb-numb-bx sale-hist-data sup-tick-btn-flex">
                                    ...
                                    <button className='supp-btn-orng'>
                                        Assigned
                                    </button>
            ...
            <section className={ticketForm ? "ticket-form-comp ticktformactive" : "ticket-form-comp"}>
...
{fileInputs.map((inputIndex) => (
  <div key={inputIndex} className='input-file'>
    <input type="file" accept='image/*' name={`fileInput-${inputIndex}`} id='input_file'  />
...
<button onClick={addInputFile} className='add-input-file-bx'> <i class="fa-solid fa-plus"></i> Add </button>
    ...
    <div className="ticket-submit-cancel-btn">
        ...
        <button onClick={handleTicketSubmit} className="tickt-submit-btn">
            Submit Ticket
        </button>

        <div>
    { submitTicketText && <span className='tickt-text'>Thankyou, Your Ticket has been Submitted, Will update you soons</span> }
        </div>
