        ...
        <div className="user-prof-contanier">
          <div className="user-prf-main">
            <div className="user-img">
              <img src="../public/images/customImg/user-prf-img.webp" alt="" />
            </div>
            ...
            <div className="right-tabs-bx">
              ...
              >
                <div className="tab-main-bx">
                  ...
                  <p className="tex-line">Location</p>
                  ...
                  <p className="tex-line mt-4">Current address</p>
                  ...
                  <table>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>850.00</td>
                        <td>Wallet</td>
                        <td>CSS08931 <div className="inv-icon">
                ...
                <div className="offer-card-grid">
                  <div className="offer-main-bx">
                    <div className="offer-img">
                      <img
                        src="../public/images/customImg//offer-1.jpg"
                        alt=""
                      />
                    </div>
                  ...
                  <div className="offer-main-bx">
                    <div className="offer-img">
                      <img
                        src="../public/images/customImg//offer-2.jpg"
                        alt=""
                      />
                    </div>
                    <div className="offer-bx">
                  ...
                  <div className="offer-main-bx">
                    <div className="offer-img">
                      <img
                        src="../public/images/customImg//offer-3.jpg"
                        alt=""
                      />
                    </div>
                    <div className="offer-bx">
