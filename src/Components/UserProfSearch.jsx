...
<div className="right-user-prof-search-flex-bx">
    ...
    <button onClick={() => setPrfEditForm(true)} className="u-prf-btn-bx">
        Edit Profile
    </button>
...
<section className={prfEditForm === true ? "user-prof-edit-popup-comp editpopupcompshow" : "  user-prof-edit-popup-comp"}>
