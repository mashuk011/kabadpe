...
const SideProduct = () => {
  ...
  return (
    ...
    <section className="product-side-comp">
        ...
        <div className= { sidechat ? "chat-message-main-bx chat-message-main-bx2 chatsideactive" : "chat-message-main-bx chat-message-main-bx2"}>
        ...
        <div onClick={() => setSideChat(!sidechat)} className={sidechat ? "minimize-maximize-btn minimaxiactive" : "minimize-maximize-btn"}>
