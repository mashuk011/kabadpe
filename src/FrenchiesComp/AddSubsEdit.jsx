...
const AddSubsEdit = ({onclickCloseSubsPlanBx , subsTrue}) => {
  ...
  return (
    <>
      <section className="add-work-area-edit-comp" onClick={onclickCloseSubsPlanBx}>
        <div className="add-work-area-edit-main-bx add-subs-plan" onClick={(e)=> e.stopPropagation()}>
